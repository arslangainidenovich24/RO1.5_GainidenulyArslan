...
('Andrey', 'Gorodenskiy', 'CS2 Tactics', '2021-06-01'),      -- B1ad3 (NaVi)
('Kanishka', 'Sosalale', 'Dota 2 Strategy', '2022-02-15'),    -- BuLba (Shopify/EG)
('Danny', 'Sorensen', 'Sniper Training', '2023-01-10'),       -- zonic (Falcons/Astralis)
('Finn', 'Andersen', 'Rifle Aiming', '2024-05-01'),           -- karrigan (FaZe)
('Jeong', 'Gyun-chul', 'Midlane Control', '2020-04-01');       -- kkOma (T1)
...
((SELECT team_id FROM Team WHERE team_name = 'Saimans CS2'), 'Abay', 'Khassenov', 'HObbit', 'IGL', '2022-01-15', '1994-05-18'),
((SELECT team_id FROM Team WHERE team_name = 'Saimans CS2'), 'Oleksandr', 'Kostyliev', 's1mple', 'Awper', '2023-03-20', '1997-10-02'),
((SELECT team_id FROM Team WHERE team_name = 'Virtus Dota'), 'Aibek', 'Tokayev', 'TA2000', 'Carry', '2022-11-01', '2000-05-24'),
((SELECT team_id FROM Team WHERE team_name = 'Virtus Dota'), 'Oleg', 'Kalenbet', 'sayuw', 'Support', '2023-05-14', '1997-03-20'),
((SELECT team_id FROM Team WHERE team_name = 'NaVi Junior'), 'Ilya', 'Osipov', 'm0NESY', 'Awper', '2021-02-10', '2005-05-01'),
((SELECT team_id FROM Team WHERE team_name = 'NaVi Junior'), 'Valeriy', 'Vakhovskiy', 'b1t', 'Rifler', '2021-05-12', '2003-01-05'),
((SELECT team_id FROM Team WHERE team_name = 'G2 Academy'), 'Martin', 'Larsson', 'Rekkles', 'ADC', '2023-01-05', '1996-09-20'),
((SELECT team_id FROM Team WHERE team_name = 'G2 Academy'), 'Rasmus', 'Winther', 'Caps', 'Mid', '2023-06-11', '1999-11-17'),
((SELECT team_id FROM Team WHERE team_name = 'T1 Challengers'), 'Ryu', 'Min-seok', 'Keria', 'Support', '2022-08-19', '2002-10-14'),
((SELECT team_id FROM Team WHERE team_name = 'T1 Challengers'), 'Mun', 'Hyeon-jun', 'Oner', 'Jungler', '2022-09-01', '2002-12-24');
...
-- Create roles
CREATE ROLE esports_readonly;
CREATE ROLE esports_writer;
